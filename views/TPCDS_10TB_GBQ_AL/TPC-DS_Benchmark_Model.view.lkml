view: TPC_DS_Benchmark_Model {
    ...
    sql_table_name: "TPCDS 10TB GBQ AL"."TPC-DS Benchmark Model";;
    dimension: Ss_Ticket_Number_Hierarchy_Ss_Ticket_Number_Level {
        label: "Ss_Ticket_Number Level"
        type: number
        sql: ${TABLE}.`Ss_Ticket_Number Level`;;
    }
