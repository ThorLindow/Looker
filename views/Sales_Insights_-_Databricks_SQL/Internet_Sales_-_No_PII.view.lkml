view: Internet_Sales___No_PII {
    label: "Internet Sales - No PII"
    sql_table_name: "Sales Insights - Databricks SQL"."Internet Sales - No PII";;
    ...
    set: Customer_Details {
        fields: [Geography_City_City,Geography_City_State,Geography_Zip_Zip_Code,orderquantity1,salesamount1]
    }

    set: Shipping_Details {
        fields: [Product_Dimension_Product_Name,Color,Size,Style,orderquantity1,salesamount1]
    }
