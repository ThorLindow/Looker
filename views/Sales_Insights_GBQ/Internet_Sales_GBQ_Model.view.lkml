view: Internet_Sales_GBQ_Model {
    label: "Internet Sales GBQ Model"
    sql_table_name: "Sales Insights GBQ"."Internet Sales GBQ Model";;
    ...
    measure: 1QtySold_no_color {
        label: "1QtySold_no color"
        type: count_distinct
        sql: ${TABLE}.`1QtySold_no color`;;
    }

    measure: Color_PercentageContribution {
        label: "Color PercentageContribution"
        value_format: "0.00%"
        type: average
        sql: ${TABLE}.`Color PercentageContribution`;;
    }
