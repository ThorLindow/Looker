#
# This LookML file was generated by AtScale on 2020-04-24T21:36:16.171097Z
#
...
Set(    dimension: Customer_Hierarchy.Customer_Name {
        label: "Customer Name"
...
)Set(    dimension: Customer_Hierarchy.Gender {
        label: "Gender"
        group_label: "Customer Attributes"
        type: string
        sql: ${TABLE}.`Gender`;;
...
)Set(    dimension: Geography_City.City {
        label: "  City"
...
)Set(    dimension: Geography_City.CountryCity {
        label: "    Country"
        group_label: "Customer Attributes.Geography City"
        type: string
...
)Set(    dimension: Geography_City.State {
        label: "   State"
        group_label: "Customer Attributes.Geography City"
        type: string
        sql: ${TABLE}.`State`;;
...
)Set(    dimension: Geography_Zip.CountryZip {
        label: "   Country"
...
)Set(    dimension: Geography_Zip.Zip_Code {
        label: "  Zip Code"
        group_label: "Customer Attributes.Geography Zip"
        type: string
        sql: ${TABLE}.`Zip Code`;;
...
)Set(    dimension: Order_Reporting_Day_Of_Month {
...
)Set(    dimension: Order_Reporting_Day_Of_Week {
...
)Set(    dimension: Order_Reporting_Day_Of_Year {
...
)Set(    dimension: Order_Reporting_Half_Year_Of_Year {
...
)Set(    dimension: Order_Reporting_Month_Of_Quarter {
...
)Set(    dimension: Order_Reporting_Month_Of_Year {
...
)Set(    dimension: Order_Reporting_Quarter_Of_Year {
...
)Set(    dimension: Order_Reporting_Week_Of_Month {
...
)Set(    dimension: Order_Reporting_Week_Of_Year {
...
)Set(    dimension: Order_W_Day_Date {
...
)Set(    dimension: Order_d_Custom_Day_Of_Month {
...
)Set(    dimension: Order_d_Custom_Day_Of_Week {
...
)Set(    dimension: Order_d_Custom_Day_Of_Year {
...
)Set(    dimension: Order_d_Custom_Month_Name {
...
)Set(    dimension: Order_d_Custom_Month_Of_Quarter {
...
)Set(    dimension: Order_d_Custom_Month_Of_Year {
...
)Set(    dimension: Order_d_Custom_Quarter_Of_Year {
...
)Set(    dimension: Order_d_Custom_Week_Of_Month {
...
)Set(    dimension: Order_d_Custom_Week_Of_Year {
...
)Set(    dimension: Order_d_Reporting_Month_Name {
...
)Set(    dimension: Order_d_day_of_month {
...
)Set(    dimension: Order_d_day_of_week_name {
...
)Set(    dimension: Order_d_day_of_week_number {
...
)Set(    dimension: Order_d_month_of_year {
...
)Set(    dimension: Order_d_quarter_number {
...
)Set(    dimension: Order_d_week_of_year {
...
)Set(    dimension: Order_w_day_of_week_name {
...
)Set(    dimension: Order_w_day_of_week_number {
...
)Set(    dimension: Ship_Reporting_Day_Of_Month {
...
)Set(    dimension: Ship_Reporting_Day_Of_Week {
...
)Set(    dimension: Ship_Reporting_Day_Of_Year {
...
)Set(    dimension: Ship_Reporting_Half_Year_Of_Year {
...
)Set(    dimension: Ship_Reporting_Month_Of_Quarter {
...
)Set(    dimension: Ship_Reporting_Month_Of_Year {
...
)Set(    dimension: Ship_Reporting_Quarter_Of_Year {
...
)Set(    dimension: Ship_Reporting_Week_Of_Month {
...
)Set(    dimension: Ship_Reporting_Week_Of_Year {
...
)Set(    dimension: Ship_d_Custom_Day_Of_Month {
...
)Set(    dimension: Ship_d_Custom_Day_Of_Week {
...
)Set(    dimension: Ship_d_Custom_Day_Of_Year {
...
)Set(    dimension: Ship_d_Custom_Month_Name {
...
)Set(    dimension: Ship_d_Custom_Month_Of_Quarter {
...
)Set(    dimension: Ship_d_Custom_Month_Of_Year {
...
)Set(    dimension: Ship_d_Custom_Quarter_Of_Year {
...
)Set(    dimension: Ship_d_Custom_Week_Of_Month {
...
)Set(    dimension: Ship_d_Custom_Week_Of_Year {
...
)Set(    dimension: Ship_d_Reporting_Month_Name {
...
)Set(    dimension: Ship_d_day_of_month {
...
)Set(    dimension: Ship_d_day_of_week_name {
...
)Set(    dimension: Ship_d_day_of_week_number {
...
)Set(    dimension: Ship_d_month_of_year {
...
)Set(    dimension: Ship_d_quarter_number {
...
)Set(    dimension: Ship_d_week_of_year {
...
)Set(    dimension: Ship_w_day_of_week_name {
...
)Set(    dimension: Ship_w_day_of_week_number {
...
)Set(    dimension: CustomPP445.Order_customday {
...
)Set(    dimension: CustomPP445.Order_custommonth {
...
)Set(    dimension: CustomPP445.Order_customquarter {
...
)Set(    dimension: CustomPP445.Order_customweek {
...
)Set(    dimension: CustomPP445.Order_customyear {
...
)Set(    dimension: Date_Week_Hierarchy.Order_DayMonth {
        label: " Order Day"
...
)Set(    dimension: Date_Month_Hierarchy.Order_Month1 {
        label: "  Order Month"
        group_label: "Date Attributes.Order Date Month Hierarchy"
        type: string
...
)Set(    dimension: Date_Month_Hierarchy.Order_Quarter {
        label: "   Order Quarter"
        group_label: "Date Attributes.Order Date Month Hierarchy"
        type: string
...
)Set(    dimension: Date_Month_Hierarchy.Order_YearMonth {
        label: "    Order Year"
...
)Set(    dimension: Date_Week_Hierarchy.Order_Week {
        label: "  Order Week"
        group_label: "Date Attributes.Order Date Week Hierarchy"
        type: string
...
)Set(    dimension: Date_Week_Hierarchy.Order_YearWeek {
        label: "   Order Year"
        group_label: "Date Attributes.Order Date Week Hierarchy"
        type: string
...
)Set(    dimension: Retail445.Order_ReportIng_Half_Year {
...
)Set(    dimension: Retail445.Order_ReportIng_Month {
...
)Set(    dimension: Retail445.Order_ReportIng_Quarter {
...
)Set(    dimension: Retail445.Order_ReportIng_Week {
...
)Set(    dimension: Retail445.Order_ReportIng_Year {
...
)Set(    dimension: Retail445.Order_Reporting_Day {
...
)Set(    dimension: CustomPP445.Ship_customday {
...
)Set(    dimension: CustomPP445.Ship_custommonth {
...
)Set(    dimension: CustomPP445.Ship_customquarter {
...
)Set(    dimension: CustomPP445.Ship_customweek {
...
)Set(    dimension: CustomPP445.Ship_customyear {
...
)Set(    dimension: Date_Week_Hierarchy.Ship_DayMonth {
        label: " Ship Day"
        description: "Day level of standard calendar Month Hierarchy"
...
)Set(    dimension: Date_Month_Hierarchy.Ship_Month1 {
        label: "  Ship Month"
        group_label: "Date Attributes.Ship Date Month Hierarchy"
        type: string
...
)Set(    dimension: Date_Month_Hierarchy.Ship_Quarter {
        label: "   Ship Quarter"
        group_label: "Date Attributes.Ship Date Month Hierarchy"
        type: string
...
)Set(    dimension: Date_Month_Hierarchy.Ship_YearMonth {
        label: "    Ship Year"
        description: "Year level of the Standard Calendar Month Hierarchy."
        group_label: "Date Attributes.Ship Date Month Hierarchy"
        type: string
...
)Set(    dimension: Date_Week_Hierarchy.Ship_Week {
        label: "  Ship Week"
        group_label: "Date Attributes.Ship Date Week Hierarchy"
        type: string
        sql: ${TABLE}.`Ship Week`;;
...
)Set(    dimension: Date_Week_Hierarchy.Ship_YearWeek {
        label: "   Ship Year"
        group_label: "Date Attributes.Ship Date Week Hierarchy"
        type: string
...
)Set(    dimension: Retail445.Ship_ReportIng_Half_Year {
...
)Set(    dimension: Retail445.Ship_ReportIng_Month {
...
)Set(    dimension: Retail445.Ship_ReportIng_Quarter {
...
)Set(    dimension: Retail445.Ship_ReportIng_Week {
...
)Set(    dimension: Retail445.Ship_ReportIng_Year {
...
)Set(    dimension: Retail445.Ship_Reporting_Day {
...
)Set(    dimension: Order_Dimension.currency {
        label: "   Currency"
...
)Set(    dimension: Order_Dimension.order {
        label: "  Order"
        group_label: "Orders.Order Dimension"
        type: string
        sql: ${TABLE}.`order`;;
...
)Set(    dimension: Order_Dimension.order_line_item {
...
)Set(    dimension: d_productsubcategoryId {
...
)Set(    dimension: Product_Dimension.Product_Category {
...
)Set(    dimension: Product_Dimension.Product_Line {
        label: "   Product Line"
...
)Set(    dimension: Product_Dimension.Product_Name {
        label: " Product Name"
