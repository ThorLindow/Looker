#
# This LookML file was generated by AtScale on 2021-01-27T18:31:55.743626Z
#
# AtScale Egine Version: 2021.1.0.3350
# Organization: default
# Project: AtScale  on AtScale_2021-01-27T18:31:55.586114Z
# Cube: Marketing Leads Channels

view: Marketing_Leads_Channels {
    label: "Marketing Leads Channels"
    sql_table_name: "AtScale  on AtScale_2021-01-27T18:31:55.586114Z"."Marketing Leads Channels";;
    ...
    dimension: d_cross_reporting_filter {
        label: "Cross Reporting Filter"
        group_label: "Channels"
        type: yesno
        sql: ${TABLE}.`d_cross_reporting_filter`;;
    }

    dimension: d_lead_source_d_lead_source_attr {
        label: "Lead Source"
        group_label: "Channels"
        type: string
        sql: ${TABLE}.`d_lead_source_attr`;;
    }
    ...
    measure: m_new_leads_conversion_rate_avg {
        label: "New User Conversion Rate"
    ...
    measure: m_converted_leads_avg {
        label: "Web Session Conversion Rate"
        group_label: "Conversions"
        value_format: "0.00%"
        type: average
