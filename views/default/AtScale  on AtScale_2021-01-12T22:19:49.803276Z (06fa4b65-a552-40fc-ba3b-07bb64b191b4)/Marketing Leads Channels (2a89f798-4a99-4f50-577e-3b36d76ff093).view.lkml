#
# This LookML file was generated by AtScale on 2021-01-23T01:21:04.416719Z
#
...
view: Marketing_Leads_Channels {
    ...
    sql_table_name: "AtScale  on AtScale_2021-01-23T01:21:04.299796Z"."Marketing Leads Channels";;
    ...
    dimension: UTM_Clean_Medium_Clean {
        label: "   Medium Clean"
        group_label: "UTM Clean"
        type: string
        sql: ${TABLE}.`Medium Clean`;;
        drill_fields: [UTM_Clean_Source_Clean]
    }

    dimension: UTM_Clean_Source_Clean {
        label: "  Source Clean"
        group_label: "UTM Clean"
        type: string
        sql: ${TABLE}.`Source Clean`;;
        drill_fields: [UTM_Clean_d_utm_key]
    }

    dimension: UTM_Clean_d_utm_key {
        label: " UTM Key"
        group_label: "UTM Clean"
        type: string
        sql: ${TABLE}.`d_utm_key`;;
