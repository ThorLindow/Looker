#
# This LookML file was generated by AtScale on 2020-12-18T17:46:39.854785Z
#
...
view: Internet_Sales_Cube {
    ...
    dimension: Visit_Day_Date {
        label: "Visit Day Date"
        group_label: "Date Attributes"
        type: date_time
        sql: ${TABLE}.`Visit Day_Date`;;
    }

    dimension: Visit_W_Day_Date {
        label: "Visit W Day Date"
        group_label: "Date Attributes"
        type: date_time
        sql: ${TABLE}.`Visit W_Day_Date`;;
    }

    dimension: Visit_d_day_of_month {
        label: "Visit Day Of Month"
        group_label: "Date Attributes"
        type: number
        sql: ${TABLE}.`Visit d_day_of_month`;;
    }

    dimension: Visit_d_day_of_week_name {
        label: "Visit Day Of Week Name"
        group_label: "Date Attributes"
        type: string
        sql: ${TABLE}.`Visit d_day_of_week_name`;;
    }

    dimension: Visit_d_day_of_week_number {
        label: "Visit Day Of Week Number"
        group_label: "Date Attributes"
        type: number
        sql: ${TABLE}.`Visit d_day_of_week_number`;;
    }

    dimension: Visit_d_month_of_year {
        label: "Visit Month Of Year"
        group_label: "Date Attributes"
        type: number
        sql: ${TABLE}.`Visit d_month_of_year`;;
    }

    dimension: Visit_d_quarter_number {
        label: "Visit Quarter Number"
        group_label: "Date Attributes"
        type: number
        sql: ${TABLE}.`Visit d_quarter_number`;;
    }

    dimension: Visit_d_week_of_year {
        label: "Visit Week Of Year"
        group_label: "Date Attributes"
        type: number
        sql: ${TABLE}.`Visit d_week_of_year`;;
    }

    dimension: Visit_w_day_of_week_name {
        label: "Visit W Day Of Week Name"
        group_label: "Date Attributes"
        type: string
        sql: ${TABLE}.`Visit w_day_of_week_name`;;
    }

    dimension: Visit_w_day_of_week_number {
        label: "Visit W Day Of Week Number"
        group_label: "Date Attributes"
        type: number
        sql: ${TABLE}.`Visit w_day_of_week_number`;;
    }
    ...
    dimension: Date_Month_Hierarchy_Visit_DayMonth {
        label: " Visit Day"
        description: "Day level of standard calendar Month Hierarchy"
        group_label: "Date Attributes.Visit Date Month Hierarchy"
        type: string
        sql: ${TABLE}.`Visit DayMonth`;;
    }

    dimension: Date_Month_Hierarchy_Visit_Month1 {
        label: "  Visit Month"
        group_label: "Date Attributes.Visit Date Month Hierarchy"
        type: date
        sql: ${TABLE}.`Visit Month1`;;
        drill_fields: [Date_Month_Hierarchy_Visit_DayMonth]
    }

    dimension: Date_Month_Hierarchy_Visit_Quarter {
        label: "   Visit Quarter"
        group_label: "Date Attributes.Visit Date Month Hierarchy"
        type: string
        sql: ${TABLE}.`Visit Quarter`;;
        drill_fields: [Date_Month_Hierarchy_Visit_Month1]
    }

    dimension: Date_Month_Hierarchy_Visit_YearMonth {
        label: "    Visit Year"
        description: "Year level of the Standard Calendar Month Hierarchy."
        group_label: "Date Attributes.Visit Date Month Hierarchy"
        type: string
        sql: ${TABLE}.`Visit YearMonth`;;
        drill_fields: [Date_Month_Hierarchy_Visit_Quarter]
    }

    dimension: Date_Week_Hierarchy_Visit_DayMonth {
        label: " Visit Day"
        description: "Day level of standard calendar Month Hierarchy"
        group_label: "Date Attributes.Visit Date Week Hierarchy"
        type: string
        sql: ${TABLE}.`Visit DayMonth`;;
    }

    dimension: Date_Week_Hierarchy_Visit_Week {
        label: "  Visit Week"
        group_label: "Date Attributes.Visit Date Week Hierarchy"
        type: string
        sql: ${TABLE}.`Visit Week`;;
        drill_fields: [Date_Week_Hierarchy_Visit_DayMonth]
    }

    dimension: Date_Week_Hierarchy_Visit_YearWeek {
        label: "   Visit Year"
        group_label: "Date Attributes.Visit Date Week Hierarchy"
        type: string
        sql: ${TABLE}.`Visit YearWeek`;;
        drill_fields: [Date_Week_Hierarchy_Visit_Week]
    }
    ...
    dimension: SafeGraph_Brand_Dimension_SafeGraph_Brand {
        label: "SafeGraph Brand"
        group_label: "Third Party"
        type: string
        sql: ${TABLE}.`SafeGraph Brand`;;
    }
    ...
    measure: m_VISITS_sum {
        label: "Safegraph Visits"
        group_label: "Third Party"
        value_format: "#,##0"
        type: sum
        sql: ${TABLE}.`m_VISITS_sum`;;
    }
