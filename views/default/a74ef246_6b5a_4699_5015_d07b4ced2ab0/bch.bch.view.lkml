#
# This LookML file was generated by AtScale on 2020-04-30T23:29:27.379258Z
#
...
view: BCH {
    ...
    dimension: Date_Dim_D_Month_Sequence {
        label: "   Month"
        group_label: "Date Dimension.Date Dim"
        type: number
        sql: ${TABLE}.`D Month Sequence`;;
        drill_fields: [Date_Dim_Week]
    }
    ...
    dimension: Date_Dim_YEAR1 {
        label: "    Year"
        group_label: "Date Dimension.Date Dim"
        type: number
        sql: ${TABLE}.`YEAR1`;;
        drill_fields: [Date_Dim_D_Month_Sequence]
    }
    ...
    dimension: Geo_Dimension_Security___State_Geo_Dimension_Security___State_user_id {
    ...
    dimension: Geo_Dimension_Comm_UnitY {
        label: "  Community"
    ...
    dimension: Geo_Dimension_Country {
        label: "     Country"
        group_label: "Geo Dimension.Geographic Dimension"
        type: string
        sql: ${TABLE}.`Country`;;
        drill_fields: [Geo_Dimension_State1]
    }

    dimension: Geo_Dimension_County {
        label: "   County"
        group_label: "Geo Dimension.Geographic Dimension"
        type: string
        sql: ${TABLE}.`County`;;
        drill_fields: [Geo_Dimension_Comm_UnitY]
    }
    ...
    dimension: Geo_Dimension_State1 {
        label: "    State"
        group_label: "Geo Dimension.Geographic Dimension"
        type: string
        sql: ${TABLE}.`State1`;;
        drill_fields: [Geo_Dimension_County]
    }
    ...
    dimension: Urgent_Care_Center_Urgent_Care_Center {
    ...
    dimension: Received_Flu_Vaccine_Received_Flu_Vacc_InE {
    ...
    dimension: Result_For_COVID19_Test_Result_For_Cov_Id19_Test {
    ...
    measure: m_OID_distinct {
        label: "Row Count"
        drill_fields: [Default_Drill_Through_12004efffb02bbbf626df22fca9e1e79*]
        type: count_distinct
    ...
    set: Default_Drill_Through_12004efffb02bbbf626df22fca9e1e79 {
        fields: [Urgent_Care_Center_Urgent_Care_Center,Age_Buckets,Other,Runnyorstuffynose,Measured,m_DAYS_IN_QUARANTINE_sum,m_num_csfc_avg,Cov_Id_Symptoms_Fever_And_Shortness_Ofbreath,Direct_Contact_With_COVID,In_Store_Clinic,Hospital_Overnight,Rash,m_num_cli_sum,m_num_cli_avg,Fever,Sneezing,m_NUM_DIRECT_CONTACT_WITH_COVID_sum,Diarrhea,m_CALCULATED_AGE_avg,Cov_Id_Like_Illness,Received_Flu_Vaccine_Received_Flu_Vacc_InE,m_num_csfs_sum,Traveled_Outside_Country_Last_14_Days,m_TEMPERATURE_STANDARDIZED_avg,Fatigue,m_NUM_SEEN_HEALTH_PROFESSIONAL_sum,Nausea,m_num_csfs_stddev_samp,Result_For_COVID19_Test_Result_For_Cov_Id19_Test,Seen_Health_Professional,m_NUM_TRAVELED_OUTSIDE_COUNTRY_LAST_14_DAYS_sum,Sorethroat,Cough,Cov_Id_Symptoms_Fever_And_Cough,Headaches,Chills_Or_Night_Sweats,m_num_csfs_avg,m_num_cli_stddev_samp,Doctors_Office_Or_Hmo,Short_Ness_Of_Breath,Otherdetails,m_TEMPERATURE_STANDARDIZED_stddev_pop,m_TEMPERATURE_STANDARDIZED_stddev_samp,m_TEMPERATURE_STANDARDIZED_var_pop,m_NUM_HOSPITAL_OVERNIGHT_sum,m_NUM_TESTED_FOR_COVID19_sum,m_NUM_MEASURED_sum,m_num_csfc_stddev_samp,Gender,m_DAYS_IN_QUARANTINE_avg,Emergency_Room,m_OID_distinct,m_TEMPERATURE_STANDARDIZED_var_samp,Virtual_Care,m_num_csfc_sum,Aches_and_pains,Tested_For_Cov_Id19]
    }
