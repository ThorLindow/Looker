#
# This LookML file was generated by AtScale on 2020-05-05T18:55:39.685750Z
#
...
view: COVID_19_CovidTracking_API_Model {
    ...
    dimension: US_Geo_Dimension_2_State_Mitigations {
        label: "    State Mitigations"
        group_label: "Geography.US Geo Dimension"
        type: string
        sql: ${TABLE}.`State Mitigations`;;
        drill_fields: [US_Geo_Dimension_2_State1_us]
    }

    dimension: US_Geo_Dimension_2_State1_us {
        label: "   State"
        group_label: "Geography.US Geo Dimension"
        type: string
        sql: ${TABLE}.`State1_us`;;
    ...
    measure: m_DEATH_max {
        ...
        drill_fields: [Default_Drill_Through_cf9e396aa5199d7198db0946531c04d7*]
        type: max
    ...
    measure: m_HOSPITALS_sum {
        ...
        drill_fields: [Default_Drill_Through_0e9476f17f7f000bb123c252a9ea67eb*]
        type: sum
    ...
    measure: m_TOTAL_FEMALE_POPULATION_sum {
        ...
        drill_fields: [Default_Drill_Through_439e3c825023647b85e66aae91ea243e*]
        type: sum
    ...
    set: Default_Drill_Through_cf9e396aa5199d7198db0946531c04d7 {
        fields: [m_TOTAL_max,m_HOSPITALIZED_sum,Date_Dimension_6,Date_Dimension_2,m_POSITIVE_max,Date_Dimension_5,Date_Dimension_3,m_HOSPITALIZED_max,m_NEGATIVE_sum,m_NEGATIVE_max,m_TOTAL_sum,m_PENDING_sum,m_DEATH_sum,m_DEATH_max,m_POSITIVE_sum]
    }

    set: Default_Drill_Through_0e9476f17f7f000bb123c252a9ea67eb {
        fields: [m_ICU_BEDS_sum,m_HOSPITALS_sum]
    }

    set: Default_Drill_Through_439e3c825023647b85e66aae91ea243e {
        fields: [m_TOTAL_FEMALE_POPULATION_sum,m_TOTAL_MALE_POPULATION_sum,m_TOTAL_POPULATION_sum]
    }
