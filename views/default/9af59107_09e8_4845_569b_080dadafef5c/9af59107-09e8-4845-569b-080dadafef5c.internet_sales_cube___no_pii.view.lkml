#
# This LookML file was generated by AtScale on 2020-05-15T16:38:13.546908Z
#
# AtScale Egine Version: 2020.3.0-SNAPSHOT
# Organization: default
# Project: Sales Insights
# Cube: Internet Sales Cube - No PII

view: Internet_Sales_Cube___No_PII {
    label: "Internet Sales Cube - No PII"
    sql_table_name: "Sales Insights"."Internet Sales Cube - No PII";;
    ...
    dimension: Geography_Dimension_Security_Geography_Dimension_Security_user_id {
        label: "Geography Dimension Security"
        group_label: "Customer Attributes"
        type: string
        sql: ${TABLE}.`Geography Dimension Security_user_id`;;
    }
    ...
    dimension: d_Hashed_Full_Name {
        label: "Hashed Full Name"
        group_label: "Customer Attributes"
        type: number
        sql: ${TABLE}.`d_Hashed Full Name`;;
    }
    ...
    dimension: redacted_full_name {
        label: "Redacted Full Name"
        group_label: "Customer Attributes"
        type: string
        sql: ${TABLE}.`redacted_full_name`;;
    }
