#
# This LookML file was generated by AtScale on 2021-01-22T21:46:44.375596Z
#
...
view: Demo_Cube {
    label: "Demo Cube"
    sql_table_name: "Model for Demo"."Demo Cube";;

    dimension: Customer_Dimenstion_Security_Customer_Dimenstion_Security_user_id {
        label: "Customer Dimenstion Security"
        type: string
        sql: ${TABLE}.`Customer Dimenstion Security_user_id`;;
    }
